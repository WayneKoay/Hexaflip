...
public class AnalogStick : MonoBehaviour 
{
	...
	//! Get analog stick direction and magnitude.
	public void getDirection(out Vector2 dir, out float mag)
	{
		// Zero out direction if no finger is touching.
		if (mFingerID == -1)
		{
			dir = Vector2.zero;
			mag = 0.0f;
		...
		// Zero out the direction if magnitude is too small.
		...
		// Normalmize direction.
		dir /= mag;
		
		// Normalize magnitude.
		mag = Mathf.Clamp01(mag / mRadius);
	}
